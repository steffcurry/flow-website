      ...
      <section className="relative py-16 sm:py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12 sm:mb-16">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6 text-slate-100 drop-shadow-[0_0_30px_rgba(6,182,212,0.3)]">
          ...
          <div className="bg-gradient-to-br from-slate-900/40 to-slate-800/20 backdrop-blur-sm border-2 border-emerald-500/30 rounded-2xl p-6 sm:p-8 md:p-12 shadow-xl shadow-emerald-500/10">
            {submitted ? (
              <div className="text-center py-8 sm:py-12">
                <div className="inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-emerald-500/20 border-2 border-emerald-500/40 mb-4 sm:mb-6 shadow-lg shadow-emerald-500/30">
              ...
              <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 sm:py-3.5 bg-slate-800/50 border-2 border-cyan-500/30 rounded-xl text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500/50 transition-all text-base"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-3 sm:py-3.5 bg-slate-800/50 border-2 border-cyan-500/30 rounded-xl text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500/50 transition-all resize-none text-base"
          ...
          <div className="mt-8 sm:mt-12 bg-gradient-to-r from-teal-500/10 via-emerald-500/10 to-cyan-500/10 border-2 border-teal-500/30 rounded-xl p-5 sm:p-6 shadow-lg shadow-teal-500/10">
