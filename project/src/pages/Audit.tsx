...
const DELIVERABLES_EN = [
  { Icon: FileSearch, name: 'Workflow Report', description: 'A visual map of how your current operations actually work — not how they are described. Every manual step, handoff, and decision point documented.', value: 'You see your business from the outside for the first time. Most owners discover 3–5 bottlenecks they did not know existed.' },
