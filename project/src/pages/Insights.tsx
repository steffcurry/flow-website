...
const articles = [
  ...
  {
    tag: 'AI Models',
    title: 'GPT-4o vs Claude vs Gemini for Business Automation: A Practical Comparison',
    excerpt: 'Not all LLMs behave the same way when handling Greek language, structured data extraction, or multi-step reasoning. Here is what we have learned from deploying all three.',
    readTime: '8 min read',
    date: 'Coming soon',
    slug: null,
  },
        ...
        <div className="max-w-5xl mx-auto">
          <FadeIn>
            <div className="text-center mb-20">
              <p className="text-xs font-semibold text-cyan-400 uppercase tracking-widest mb-4">Automation Intelligence</p>
              <h1 className="text-4xl sm:text-5xl font-bold text-slate-100 mb-6">Insights</h1>
              <p className="text-xl text-slate-400 max-w-2xl mx-auto leading-relaxed">
                Practical analysis on AI automation, system design, and operational efficiency — for businesses in Greece and beyond.
              </p>
            </div>
          </FadeIn>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-20">
            {articles.map(({ tag, title, excerpt, readTime, date, slug }, i) => (
              <FadeIn key={title} delay={i * 80}>
                <div className="bg-slate-900/40 border border-slate-700/50 rounded-2xl p-7 hover:border-cyan-500/30 transition-all duration-300 h-full flex flex-col">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    {slug ? (
                      ...
                      <span className="text-slate-600 text-xs italic">Publishing soon</span>
                    )}
                  </div>
                </div>
              </FadeIn>
          ...
          {/* Newsletter */}
          <FadeIn>
            <div className="bg-gradient-to-r from-cyan-500/8 to-blue-500/8 border border-cyan-500/20 rounded-2xl p-8 sm:p-12 text-center">
              <h2 className="text-2xl sm:text-3xl font-bold text-slate-100 mb-3">One email. Every two weeks.</h2>
              <p className="text-slate-400 mb-8 max-w-md mx-auto">Practical automation insights for Greek business owners. No fluff. Unsubscribe any time.</p>
              <form
